...
import io.creedengo.java.checks.helpers.CheckArgumentComplexTypeUtils;
 ...
 */
@DeprecatedRuleKey(repositoryKey = "creedengo-android-java", ruleKey = "EC504")
@Rule(key = "GCI504")
@DeprecatedRuleKey(repositoryKey = "ecocode-android-java", ruleKey = "EBOT003")
